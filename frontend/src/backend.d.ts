...
export type WalletOperationResult_2 = {
    __kind__: "error";
    error: WalletError;
} | {
    __kind__: "success";
...
export type WalletOperationResult_1 = {
    __kind__: "error";
    error: WalletError;
} | {
    __kind__: "success";
    success: WalletCreationResult;
};
...
export interface backendInterface {
    addWalletAddress(address: string): Promise<WalletOperationResult_2>;
    ...
    createWallet(_walletLabel: string | null): Promise<WalletOperationResult_1>;
